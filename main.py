...
capture = cv2.VideoCapture(0) #Aqui você o índice da câmera que deseja utilizr
    ...
    if(processed_image.multi_hand_landmarks):
        ...
        for handLandmarks in processed_image.multi_hand_landmarks:
            ...
            for finger_id, landmark_co in enumerate(handLandmarks.landmark):
               #print(finger_id, landmark_co) #landmark_co coordinates
                ...
                if finger_id == 8:
                    ...
                    distance = math.sqrt((ipx-tpx)**2 + (ipy-tpy)**2) #TEOREMA DE PITAGORAS
                    print(distance)
